...
var _enterpriseEdit = _interopRequireDefault(__webpack_require__(/*! ./Enterprise/enterpriseEdit/enterpriseEdit.vue */ 241));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _enterpriseEdit_vue_vue_type_template_id_5d34218f_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./enterpriseEdit.vue?vue&type=template&id=5d34218f&scoped=true& */ 242);
/* harmony import */ var _enterpriseEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./enterpriseEdit.vue?vue&type=script&lang=js& */ 244);
...
/* harmony import */ var _enterpriseEdit_vue_vue_type_style_index_0_id_5d34218f_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./enterpriseEdit.vue?vue&type=style&index=0&id=5d34218f&lang=scss&scoped=true& */ 246);
...
var _default =
{
  ...
  methods: {
    upLoadBusinessLicense: function upLoadBusinessLicense() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.$chooseImage());case 2:res = _context.sent;
                // console.log("res", res)
                _this.enterpriseInfo.businessLicense = res.tempFilePaths[0];case 4:case "end":return _context.stop();}}}, _callee);}))();
    },

    upLoadCompanyLogo: function upLoadCompanyLogo() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _this2.$chooseImage());case 2:res = _context2.sent;
                // console.log("res", res)
                _this2.enterpriseInfo.companyLogo = res.tempFilePaths[0];case 4:case "end":return _context2.stop();}}}, _callee2);}))();
