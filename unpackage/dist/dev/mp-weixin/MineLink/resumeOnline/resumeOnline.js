...
try {
  components = {
    tuiCollapse: function() {
      return __webpack_require__.e(/*! import() | components/thorui/tui-collapse/tui-collapse */ "components/thorui/tui-collapse/tui-collapse").then(__webpack_require__.bind(null, /*! @/components/thorui/tui-collapse/tui-collapse.vue */ 269))
    },
    tuiInput: function() {
    ...
    tuiCalendar: function() {
      return Promise.all(/*! import() | components/thorui/tui-calendar/tui-calendar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/thorui/tui-calendar/tui-calendar")]).then(__webpack_require__.bind(null, /*! @/components/thorui/tui-calendar/tui-calendar.vue */ 291))
    }
  }
} catch (e) {
  if (
...
var _city = _interopRequireDefault(__webpack_require__(/*! @/utils/city.js */ 189));
...
var _default = { data: function data() {var arr = [];for (var y = 0; y < 20; y++) {arr.push(y + 1 + 'k');}return { imageBaseSrc: this.$imageBaseSrc, salaryList: [arr, arr], cityList: [], cityLevel1: [], cityLevel2: [], cityLevel3: [], tabList: [{ label: '简历', resumeId: '', showPicker: false, showCityPicker: false, showSalaryPicker: false, viewType: '', //1公开 
    ...
    linkAddWork: function linkAddWork(index, ind, item) {if (ind == undefined) {uni.navigateTo({ url: "/MineLink/resumeOnline/addWork?index=".concat(index, "&resumeId=").concat(this.tabList[this.currentResume].resumeId, "&ind=99999") });} else {uni.navigateTo({ url: "/MineLink/resumeOnline/addWork?index=".concat(index, "&resumeId=").concat(this.tabList[this.currentResume].resumeId, "&ind=").concat(ind, "&data=").concat(JSON.stringify(item)) });}},
    //确认工作经历
